...
<div class="container-create-user">
    <div class="card">
        ...
        <form  class="form-create_user"action="../controladores/controlador_save_user.php" method="POST">
    ...
    <div class="card-create_user-content">
        ...
        <div class="lado_izquierdo">
            ...
            <input type="submit" onclick="createUser()" class="button-save-user" name="save_user" value="Confirmar">
