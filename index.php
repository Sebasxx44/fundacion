...
<section class="dashboard">
    ...
    <div class="container-filters">
            <!-- BOTON PARA AGREGAR UN NUEVO USUARIO-->
                    ...
                    <div class="new-user">
                        <a href="pages/create_user.php"><button>Agregar Tallerista <i class="fa-solid fa-user-plus"></i></button></a>
                    </div>
        ...
        <form id="form2" name="form2" method="POST" action="index.php">
            ...
            <!-- GENERADOR DE REPORTES EN EXCEL-->
                ...
                <div class="reports">
                    <a href="pages/reportes/excel_users.php"><img src="../img/excel.png" alt=""></a>
            ...
            <tbody>
                ...
                <?php While($rowSql = $sql->fetch_assoc()) {   ?>
                    ...
                    <tr>
                        ...
                        <td class="buttons">
                            <div class="mod edit"><a href="pages/edit_user.php?id=<?php echo $rowSql['id']?>"><i class="fa-solid fa-pen-to-square"></i></a></div>
